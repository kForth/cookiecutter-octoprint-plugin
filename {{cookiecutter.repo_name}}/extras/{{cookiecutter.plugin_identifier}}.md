...
screenshots:
- url: url of a screenshot, /assets/img/{{cookiecutter.plugin_identifier}}/...
  alt: alt-text of a screenshot
  caption: caption of a screenshot
- url: url of another screenshot, /assets/img/{{cookiecutter.plugin_identifier}}/...
  alt: alt-text of another screenshot
  caption: caption of another screenshot
- ...

# TODO
featuredimage: url of a featured image for your plugin, /assets/img/{{cookiecutter.plugin_identifier}}/...
